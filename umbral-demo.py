...
kfrags = pre.split_rekey(alice_priv_key, alice_signer, bob_pub_key, 10, 20)
...
# Info to verify correctness
bob_capsule.set_correctness_keys(delegating=alice_pub_key,
